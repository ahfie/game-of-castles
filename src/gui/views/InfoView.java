...
public class InfoView extends View {
	...
	private static final String ABOUT_TEXT = "~ Game of Castles ~\n"
			+ "FOP-Projekt WiSe 18/19\n" 
			+ "Projektgruppe 063\n"
			+ "Projektgruppe Mitglieder: Jonathan Geraldi Joewono, Kenneth Kartono, Liang Zhao, Wu Fei Yang\n"
	...
	protected void onInit() {
		...
		lblTitle.setSize(lblTitle.getWidth() + 25, lblTitle.getHeight());
